...
if __name__ == '__main__':
    ...
    parser.add_argument("--have-gt", action='store_true', default=True)
    parser.add_argument("--no-have-gt", action='store_false', dest='have_gt')
    ...
    if args.save_path_c not in [None, '']:
    ...
    with torch.no_grad():
        for idx in tqdm(range(len(img_list))):
            ...
            # print(f"Is {os.path.join(im_path, i.strip() + '.jpg')} exist: {os.path.exists(os.path.join(im_path, i.strip() + '.jpg'))}")
